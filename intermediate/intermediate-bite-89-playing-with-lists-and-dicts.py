...
Complete the four methods in the template below (you might have to scroll down): get_every_nth_state,
get_state_abbrev, get_longest_state and combine_state_names_and_abbreviations, following the instructions in their docstrings.

We hope this gives you a good feeling of how you can get data out of these two data structures.

Of course there is a lot more to it, you will come to appreciate the power of each data structure by continuous usage.
So keep coding and improving your Python skills. And have fun!
"""
...
def get_longest_state(data):
    ...
    if isinstance(data, list):
        ...
        return sorted(data.keys(), key=lambda x: len(x), reverse=True)[0]
...
def combine_state_names_and_abbreviations(us_state_abbrev=us_state_abbrev,
    ...
    first_half = list(us_state_abbrev.values())[0:10]
    second_half = sorted(states)[-10:]

    return first_half + second_half


print(get_every_nth_state(states, n=20))
